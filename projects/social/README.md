...
500 times. An edge between two users is a single friendship, so total number of calls would be number of users * average number of friends / 2
...
Close to 100%. Generally around 99.2%.

What is the average degree of separation between a user and those in his/her extended network?

Typically around 5, sometimes 6. See code starting at line 123.
